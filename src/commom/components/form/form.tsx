...
import useSmartViewModel from '../../../pages/smart/view.model';

export const Form = () => {
  const {gyms, getGyms, setIncludeClosed, setTime} = useSmartViewModel();
    ...
    <form className="form-group" onSubmit={e => e.preventDefault()} ref={element => setForm(element)}>
      ...
      <div className="radio-wrapper">
        <input
          ...
          name="hour"
          value="Manhã"
          onChange={e => changeSelection(setTime, e.target)}
        />
      ...
      <div className="btn-wrapper">
        ...
        <button className="btn btn-secondary" onClick={() => resetForm(, form)}>
          Limpar
        </button >
      </div>
    </form>
